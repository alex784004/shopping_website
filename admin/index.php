...
if(isset($_POST["login"]))
{
	$user=$_POST["user"];
	$pass=$_POST["pass"];
	$a="select * from login where username='$user' and password='$pass'";
	...
	$_SESSION["sitename"]=$c["sitename"];
	$_SESSION["image"]=$c["image"];
	header("location:dashboard.php");
}
?>
         ...
         <form action="" method="post" class="niceform">
                ...
                <fieldset>
                    <dl>
                        ...
                        <dd><input type="text" name="user" id="" size="30" /></dd>
                    </dl>
                    <dl>
                        <dt><label for="password">Password:</label></dt>
                        <dd><input type="password" name="pass" id="" size="30" /></dd>
                    </dl>
